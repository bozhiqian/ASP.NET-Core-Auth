...
using IdentityServerWithAspNetIdentity.Controllers.Home;
...
namespace IdentityServerWithAspNetIdentity.Controllers.Account
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> ExternalLoginCallback()
        {
            ...
            var result = await HttpContext.AuthenticateAsync(Config.ExternalScheme);
        ...
        #region User Registration and password management (These are part of generated code from ASP.NET Core 2.0 MVC template for individual account)
